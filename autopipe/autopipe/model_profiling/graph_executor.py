...
from autopipe.autopipe.utils import layerDict, tensorDict, force_out_of_place, inplace_arithmetic_ops
...
def call_function(namespaces, node, args, kwargs, pre_hook, post_hook, enforce_out_of_place=True):
    ...
    #print("PRE_HOOK:"+str(pre_hook)+" Node:"+str(node)+" function:"+str(function)+"args："+str(args)+" kwargs:"+str(kwargs))
    #if isinstance(args[0], torch.Tensor):
    #    print("args[0].shape:"+str(args[0].shape))
