"""AutoGenerated with:
python -m autopipe.partition t5 --model_name_or_path t5-3b --t5_task squad1 --lmhead --n_iter 10 --analysis_batch_size 16 --partitioning_batch_size 16 --precompute_masks --stateless_tied --lmhead --n_partitions 16 --L 16 32 48 --max_seq_length 512 --answer_max_seq_length 128 --partitioning_method mpipe --preset ftpipe --dont_use_async_meta_alg --save_memory_mode --special_blocks T5DenseReluDense --disable_op_profiling --output_file test_layer_graph_
"""
import torch
import torch.linalg
import math
...
# partition 7 {'inputs': {'inverted_encoder_attention_mask', 0, 'decoder_attention_mask', 6}, 'outputs': {8, 9, 10, 11, 12, 13, 14, 15}}
...
def create_pipeline_configuration(DEBUG=False, batch_size=16):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (CrossEntropyLoss,Embedding,Dropout,StatelessEmbedding,Linear,T5LayerNorm),
        'model_inputs': {
            'attention_mask': {
...
def test_layer_graph_t5_3b_tied_lmheads_512_128_16p_bw12_async_squad1_mpipe():
...
forward {0: 113.1, 1: 100.73, 2: 100.73, 3: 100.73, 4: 100.72, 5: 100.72, 6: 100.73, 7: 63.52, 8: 38.04, 9: 38.04, 10: 38.03, 11: 38.03, 12: 38.04, 13: 38.03, 14: 38.04, 15: 16.85}
backward {0: 159.72, 1: 175.57, 2: 175.61, 3: 175.64, 4: 175.63, 5: 175.6, 6: 175.61, 7: 168.62, 8: 72.66, 9: 72.63, 10: 72.66, 11: 72.65, 12: 72.63, 13: 72.66, 14: 72.59, 15: 47.37}
...
forward {0: 0.55, 1: 0.45, 2: 0.45, 3: 0.45, 4: 0.45, 5: 0.45, 6: 0.45, 7: 0.4, 8: 0.18, 9: 0.18, 10: 0.18, 11: 0.18, 12: 0.18, 13: 0.18, 14: 0.18, 15: 0.15}
backward {0: 0.91, 1: 0.71, 2: 0.71, 3: 0.71, 4: 0.71, 5: 0.71, 6: 0.71, 7: 0.67, 8: 0.31, 9: 0.31, 10: 0.31, 11: 0.31, 12: 0.31, 13: 0.31, 14: 0.31, 15: 0.17}

worstcase: bwd: 175.643 fwd: 113.099
Expected speedup for 16 partitions is: 6.556
Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'0.00 MB', recieve_time:'0.00 ms', out:'612.37 MB', send time:'51.03 ms'
1: input size:'603.98 MB', recieve_time:'50.33 ms', out:'603.98 MB', send time:'50.33 ms'
2: input size:'603.98 MB', recieve_time:'50.33 ms', out:'603.98 MB', send time:'50.33 ms'
3: input size:'603.98 MB', recieve_time:'50.33 ms', out:'603.98 MB', send time:'50.33 ms'
4: input size:'603.98 MB', recieve_time:'50.33 ms', out:'603.98 MB', send time:'50.33 ms'
5: input size:'603.98 MB', recieve_time:'50.33 ms', out:'603.98 MB', send time:'50.33 ms'
6: input size:'603.98 MB', recieve_time:'50.33 ms', out:'603.98 MB', send time:'50.33 ms'
7: input size:'612.37 MB', recieve_time:'51.03 ms', out:'218.10 MB', send time:'18.18 ms'
8: input size:'218.10 MB', recieve_time:'18.18 ms', out:'218.10 MB', send time:'18.18 ms'
9: input size:'218.10 MB', recieve_time:'18.18 ms', out:'218.10 MB', send time:'18.18 ms'
10: input size:'218.10 MB', recieve_time:'18.18 ms', out:'218.10 MB', send time:'18.18 ms'
11: input size:'218.10 MB', recieve_time:'18.18 ms', out:'218.10 MB', send time:'18.18 ms'
12: input size:'218.10 MB', recieve_time:'18.18 ms', out:'218.10 MB', send time:'18.18 ms'
13: input size:'218.10 MB', recieve_time:'18.18 ms', out:'218.10 MB', send time:'18.18 ms'
14: input size:'218.10 MB', recieve_time:'18.18 ms', out:'218.10 MB', send time:'18.18 ms'
15: input size:'218.10 MB', recieve_time:'18.18 ms', out:'0.00 MB', send time:'0.00 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.55, 1: 0.5, 2: 0.5, 3: 0.5, 4: 0.5, 5: 0.5, 6: 0.5, 7: 0.71, 8: 0.52, 9: 0.52, 10: 0.52, 11: 0.52, 12: 0.52, 13: 0.52, 14: 0.52, 15: 1.0} 
backward {0: 1.0, 1: 0.71, 2: 0.71, 3: 0.71, 4: 0.71, 5: 0.71, 6: 0.71, 7: 0.7, 8: 0.75, 9: 0.75, 10: 0.75, 11: 0.75, 12: 0.75, 13: 0.75, 14: 0.75, 15: 0.62}
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_no_comm': {0: 221.79,
                      ...
                      'worstcase': 221.79,
                      'worstcase_std': 0.06},
 'pipeline_vs_seq_no_comm': 6.6,
 'pipeline_with_non_parallel_comm': {0: 272.82,
                                     1: 276.3,
                                     2: 276.34,
                                     3: 276.38,
                                     4: 276.35,
                                     ...
                                     15: 64.22,
                                     'worstcase': 276.38},
 'seq_no_comm_no_recomp': {0: 160.03,
                           1: 125.69,
                           2: 125.7,
                           3: 125.73,
                           4: 125.71,
...
expected_speedup_compared_to_seq_no_recomp_no_comm: 5.070
Analysis max cuda memory used 16.53GB
"""