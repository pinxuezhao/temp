...
# partition 7 {'inputs': {0, 'decoder_attention_mask', 6, 'inverted_encoder_attention_mask'}, 'outputs': {8, 9, 10, 11, 12, 13, 14}}
...
# partition 14 {'inputs': {7, 13, 'lm_labels'}, 'outputs': {'output'}}
# model outputs {14}
    ...
    config = {
        ...
        'stages': {
            ...
            14: {
                ...
                'stage_depth': 0}},
        'stage_to_device_map': [0, 1, 2, 3, 4, 5, 6, 7, 1, 2, 4, 6, 5, 3, 0]}
...
class Partition7(nn.Module):
    ...
    def forward(self, *args):
        ...
        t_12 = torch.matmul(t_2, t_12)
        t_12 += t_10
        t_2 = t_12.float()
        t_2 = torch.nn.functional.softmax(t_2, dim=-1, _stacklevel=3, dtype=None)
        t_12 = t_2.type_as(t_12)
        t_12 = self.l_83(t_12)
...
unique_stages_on_same_gpu: [{0, 14}, {8, 1}, {9, 2}, {3, 13}, {10, 4}, {12, 5}, {11, 6}, {7}]
"stage_to_device_map": [0, 1, 2, 3, 4, 5, 6, 7, 1, 2, 4, 6, 5, 3, 0],
...
forward {0: 29.52, 1: 29.88, 2: 29.85, 3: 29.88, 4: 29.87, 5: 29.87, 6: 29.87, 7: 17.3}
backward {0: 46.08, 1: 58.36, 2: 58.18, 3: 58.34, 4: 58.22, 5: 58.39, 6: 58.19, 7: 54.69}
...
forward {0: 0.59, 1: 0.58, 2: 0.58, 3: 0.58, 4: 0.58, 5: 0.58, 6: 0.58, 7: 0.55}
backward {0: 0.78, 1: 0.78, 2: 0.78, 3: 0.78, 4: 0.78, 5: 0.78, 6: 0.78, 7: 0.74}

worstcase: bwd: 58.386 fwd: 29.880
Expected speedup for 8 partitions is: 5.542
Assuming bandwidth of 12 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'9.51 MB', recieve_time:'0.79 ms', out:'142.67 MB', send time:'11.89 ms'
1: input size:'152.12 MB', recieve_time:'12.68 ms', out:'152.12 MB', send time:'12.68 ms'
2: input size:'152.12 MB', recieve_time:'12.68 ms', out:'152.12 MB', send time:'12.68 ms'
3: input size:'152.12 MB', recieve_time:'12.68 ms', out:'152.12 MB', send time:'12.68 ms'
...
6: input size:'152.12 MB', recieve_time:'12.68 ms', out:'152.12 MB', send time:'12.68 ms'
7: input size:'142.67 MB', recieve_time:'11.89 ms', out:'9.51 MB', send time:'0.79 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.6, 1: 0.58, 2: 0.58, 3: 0.58, 4: 0.58, 5: 0.58, 6: 0.58, 7: 0.95} 
backward {0: 0.98, 1: 0.78, 2: 0.78, 3: 0.78, 4: 0.78, 5: 0.78, 6: 0.78, 7: 0.78}
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_with_non_parallel_comm': {0: 75.6,
                                     1: 88.24,
                                     2: 88.03,
                                     3: 88.22,
                                     4: 88.09,
...
expected_speedup_compared_to_seq_no_recomp_no_comm: 4.173
