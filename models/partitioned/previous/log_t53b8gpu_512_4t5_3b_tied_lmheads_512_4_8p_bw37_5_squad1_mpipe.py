"""AutoGenerated with:
python -m autopipe.partition t5 --model_name_or_path t5-3b --t5_task squad1 --lmhead --n_iter 10 --analysis_batch_size 4 --partitioning_batch_size 4 --stateless_tied --lmhead --n_partitions 8 --L 8 16 24 32 40 48 --max_seq_length 512 --answer_max_seq_length 4 --partitioning_method mpipe --save_memory_mode --special_blocks T5Block --bw 37.5 --precompute_masks --dont_use_async_meta_alg --output_file log_t53b8gpu_512_4
"""
...
# partition adjacency
# model inputs {0, 8, 15}
# partition 0 {'inputs': {'attention_mask', 'input_ids', 'decoder_input_ids'}, 'outputs': {1, 2, 3, 4, 5, 6, 7, 8}}
...
# partition 7 {'inputs': {0, 6}, 'outputs': {8, 9, 10, 11, 12, 13, 14, 15}}
# partition 8 {'inputs': {0, 'inverted_encoder_attention_mask', 'decoder_attention_mask', 7}, 'outputs': {9, 10, 11, 12, 13, 14, 15}}
# partition 9 {'inputs': {8, 7}, 'outputs': {10}}
# partition 10 {'inputs': {8, 9, 7}, 'outputs': {11}}
# partition 11 {'inputs': {8, 10, 7}, 'outputs': {12}}
# partition 12 {'inputs': {8, 11, 7}, 'outputs': {13}}
# partition 13 {'inputs': {8, 12, 7}, 'outputs': {14}}
...
def create_pipeline_configuration(DEBUG=False, batch_size=4):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (Linear,Embedding,StatelessEmbedding,Dropout,T5LayerNorm,CrossEntropyLoss),
        'model_inputs': {
            'attention_mask': {
        ...
        'stages': {
            ...
            15: {
                ...
                'stage_depth': 0}},
        'stage_to_device_map': [0, 1, 2, 3, 4, 5, 6, 7, 0, 6, 5, 2, 1, 3, 4, 7]}
...
class Partition7(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:7'):
        ...
        self.lookup = {'l_0': 'encoder.21.0.layer_norm',
                        ...
                        'l_38': 'decoder.0.1.EncDecAttention.k',
                        'l_39': 'decoder.0.1.EncDecAttention.v',
                        'l_40': 'decoder.1.1.EncDecAttention.k',
                        'l_41': 'decoder.1.1.EncDecAttention.v',
                        'l_42': 'decoder.2.1.EncDecAttention.k',
                        'l_43': 'decoder.2.1.EncDecAttention.v'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_38
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_39
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_40
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_41
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_42
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_43
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[0]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Tensor::__add___94 <=> x0
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v]
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Tensor::size_1589
        return list(flatten((t_0, t_1, t_3, t_2, t_4, t_5, t_6, t_7)))
...
class Partition8(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:8'):
        ...
        self.lookup = {'l_0': 'decoder.dropout',
                        ...
                        'l_11': 'decoder.0.1.EncDecAttention.relative_attention_bias',
                        'l_12': 'decoder.0.1.EncDecAttention.dropout',
                        'l_13': 'decoder.0.1.EncDecAttention.o',
                        'l_14': 'decoder.0.1.dropout',
                        'l_15': 'decoder.0.2.layer_norm',
                        'l_16': 'decoder.0.2.DenseReluDense.wi',
                        'l_17': 'decoder.0.2.DenseReluDense.dropout',
                        'l_18': 'decoder.0.2.DenseReluDense.wo',
                        'l_19': 'decoder.0.2.dropout',
                        'l_20': 'decoder.1.0.layer_norm',
                        'l_21': 'decoder.1.0.SelfAttention.q',
                        'l_22': 'decoder.1.0.SelfAttention.k',
                        'l_23': 'decoder.1.0.SelfAttention.v',
                        'l_24': 'decoder.1.0.SelfAttention.dropout',
                        'l_25': 'decoder.1.0.SelfAttention.o',
                        'l_26': 'decoder.1.0.dropout',
                        'l_27': 'decoder.1.1.layer_norm',
                        'l_28': 'decoder.1.1.EncDecAttention.q',
                        'l_29': 'decoder.1.1.EncDecAttention.dropout',
                        'l_30': 'decoder.1.1.EncDecAttention.o',
                        'l_31': 'decoder.1.1.dropout',
                        'l_32': 'decoder.1.2.layer_norm',
                        'l_33': 'decoder.1.2.DenseReluDense.wi',
                        'l_34': 'decoder.1.2.DenseReluDense.dropout',
                        'l_35': 'decoder.1.2.DenseReluDense.wo',
                        'l_36': 'decoder.1.2.dropout',
                        'l_37': 'decoder.2.0.layer_norm',
                        'l_38': 'decoder.2.0.SelfAttention.q',
                        'l_39': 'decoder.2.0.SelfAttention.k',
                        'l_40': 'decoder.2.0.SelfAttention.v',
                        'l_41': 'decoder.2.0.SelfAttention.dropout',
                        'l_42': 'decoder.2.0.SelfAttention.o',
                        'l_43': 'decoder.2.0.dropout',
                        'l_44': 'decoder.2.1.layer_norm',
                        'l_45': 'decoder.2.1.EncDecAttention.q',
                        'l_46': 'decoder.2.1.EncDecAttention.dropout',
                        'l_47': 'decoder.2.1.EncDecAttention.o',
                        'l_48': 'decoder.2.1.dropout',
                        'l_49': 'decoder.2.2.layer_norm',
                        'l_50': 'decoder.2.2.DenseReluDense.wi',
                        'l_51': 'decoder.2.2.DenseReluDense.dropout',
                        'l_52': 'decoder.2.2.DenseReluDense.wo',
                        'l_53': 'decoder.2.2.dropout'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Embedding[relative_attention_bias] <=> self.l_11
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_12
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_13
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_14
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_15
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_16
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_17
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_18
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerFF[2]/Dropout[dropout] <=> self.l_19
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_20
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_21
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_22
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_23
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_24
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_25
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_26
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_27
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_28
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_29
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_30
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_31
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_32
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_33
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_34
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_35
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerFF[2]/Dropout[dropout] <=> self.l_36
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_37
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_38
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_39
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_40
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_41
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_42
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_43
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_44
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_45
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_46
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_47
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_48
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_49
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_50
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_51
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_52
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerFF[2]/Dropout[dropout] <=> self.l_53
        # input1 <=> decoder_attention_mask
        # input4 <=> inverted_encoder_attention_mask
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> x0
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> x1
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> x2
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> x3
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> x4
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> x5
        # T5ForConditionalGeneration/T5Stack[decoder]/StatelessEmbedding[embed_tokens] <=> x6
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Tensor::size_1589 <=> x7
        decoder_attention_mask, inverted_encoder_attention_mask, x0, x1, x2, x3, x4, x5, x6, x7 = unflatten(args, self.input_structure)
        t_0 = self.l_0(x6)
        t_1 = self.l_1(t_0)
        t_2 = t_1.size()
        t_3 = self.l_2(t_1)
        ...
        t_7 = 16 + t_7
        t_3 = torch.full_like(t_7, 31, device=self.device)
        t_3 = torch.min(t_7, t_3)
        t_3 = torch.where(t_6, t_2, t_3)
        t_3 = 0 + t_3
        t_3 = t_3.to(self.device)
        t_3 = self.l_5(t_3)
        t_3 = t_3.permute([2, 0, 1])
        t_3 = t_3.unsqueeze(0)
        t_3 = t_3 + decoder_attention_mask
        t_4 += t_3
        t_2 = t_4.float()
        t_2 = torch.nn.functional.softmax(t_2, dim=-1, _stacklevel=3, dtype=None)
        t_4 = t_2.type_as(t_4)
        ...
        t_0 = t_0.transpose(1, 2)
        t_2 = x0.view(t_4, -1, 32, 128)
        t_2 = t_2.transpose(1, 2)
        t_6 = x1.view(t_4, -1, 32, 128)
        t_6 = t_6.transpose(1, 2)
        t_2 = t_2.transpose(3, 2)
        t_2 = torch.matmul(t_0, t_2)
        t_1 = torch.arange(t_1, dtype=torch.int64, device=self.device)
        t_1 = t_1[(slice(None, None, None), None)]
        t_0 = torch.arange(x7, dtype=torch.int64, device=self.device)
        t_0 = t_0[(None, slice(None, None, None))]
        t_1 = t_0 - t_1
        t_1 = -t_1
        t_0 = torch.zeros_like(t_1, device=self.device)
        t_0 = torch.max(t_1, t_0)
        t_1 = t_0.float()
        t_7 = torch.less(t_0, 16)
        t_1 = t_1 / 16
        t_1 = torch.log(t_1)
        t_8 = math.log(8.0)
        t_8 = t_1 / t_8
        ...
        t_8 = 16 + t_8
        t_1 = torch.full_like(t_8, 31, device=self.device)
        t_1 = torch.min(t_8, t_1)
        t_1 = torch.where(t_7, t_0, t_1)
        t_1 = 0 + t_1
        ...
        t_5 = t_5.transpose(1, 2)
        t_0 = x2.view(t_4, -1, 32, 128)
        t_0 = t_0.transpose(1, 2)
        t_2 = x3.view(t_4, -1, 32, 128)
        t_2 = t_2.transpose(1, 2)
        t_0 = t_0.transpose(3, 2)
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerCrossAttention[1]/Tensor::__add___1897
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerFF[2]/Dropout[dropout]
        return list(flatten((t_3, t_1, t_4, t_2)))
...
class Partition9(nn.Module):
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerFF[2]/Dropout[dropout] <=> x4
...
class Partition15(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:15'):
        ...
        self.lookup = {'l_0': 'decoder.21.0.layer_norm',
                        ...
                        'l_48': 'decoder.23.1.EncDecAttention.v',
                        'l_49': 'decoder.23.1.EncDecAttention.dropout',
                        'l_50': 'decoder.23.1.EncDecAttention.o',
                        'l_51': 'decoder.23.1.dropout',
                        'l_52': 'decoder.23.2.layer_norm',
                        'l_53': 'decoder.23.2.DenseReluDense.wi',
                        'l_54': 'decoder.23.2.DenseReluDense.dropout',
                        'l_55': 'decoder.23.2.DenseReluDense.wo',
                        'l_56': 'decoder.23.2.dropout',
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_48
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_49
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_50
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_51
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_52
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_53
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_54
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_55
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerFF[2]/Dropout[dropout] <=> self.l_56
        ...
        # T5ForConditionalGeneration/CrossEntropyLoss[lm_loss] <=> self.l_60
        # input5 <=> lm_labels
        # T5ForConditionalGeneration/T5Stack[encoder]/Dropout[dropout] <=> x0
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Tensor::__add___1562 <=> x1
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Tensor::__add___1658 <=> x2
...
def log_t53b8gpu_512_4t5_3b_tied_lmheads_512_4_8p_bw37_5_squad1_mpipe():
...
unique_stages_on_same_gpu: [{0, 8}, {1, 12}, {2, 11}, {3, 13}, {4, 14}, {10, 5}, {9, 6}, {15, 7}]
"stage_to_device_map": [0, 1, 2, 3, 4, 5, 6, 7, 0, 6, 5, 2, 1, 3, 4, 7],
...
forward {0: 44.66, 1: 45.61, 2: 45.63, 3: 45.1, 4: 45.65, 5: 46.05, 6: 45.0, 7: 48.97}
backward {0: 140.09, 1: 111.41, 2: 108.68, 3: 110.25, 4: 112.61, 5: 111.92, 6: 109.99, 7: 121.39}
...
forward {0: 0.83, 1: 0.85, 2: 0.85, 3: 0.84, 4: 0.85, 5: 0.86, 6: 0.84, 7: 0.89}
backward {0: 0.96, 1: 0.77, 2: 0.75, 3: 0.76, 4: 0.77, 5: 0.77, 6: 0.76, 7: 0.84}

worstcase: bwd: 140.094 fwd: 48.972
Expected speedup for 8 partitions is: 6.474
Assuming bandwidth of 37.5 GBps between GPUs

communication volumes size of activations of each partition
0: input size:'201.33 MB', recieve_time:'5.37 ms', out:'152.18 MB', send time:'4.06 ms'
...
6: input size:'152.18 MB', recieve_time:'4.06 ms', out:'152.12 MB', send time:'4.06 ms'
7: input size:'152.12 MB', recieve_time:'4.06 ms', out:'209.72 MB', send time:'5.59 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.91, 1: 0.91, 2: 0.91, 3: 0.91, 4: 0.91, 5: 0.91, 6: 0.91, 7: 0.89} 
backward {0: 0.96, 1: 0.96, 2: 0.96, 3: 0.96, 4: 0.96, 5: 0.96, 6: 0.96, 7: 0.97}
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_no_comm': {0: 175.33,
                      ...
                      7: 160.71,
                      'worstcase': 175.33},
 'pipeline_vs_seq_no_comm': 4.82,
 'pipeline_with_non_parallel_comm': {0: 184.75,
                                     1: 157.02,
                                     2: 154.31,
                                     3: 155.35,
                                     4: 158.27,
                                     ...
                                     7: 170.36,
                                     'worstcase': 184.75},
 'seq_no_comm_no_recomp': {0: 110.22,
                           1: 83.61,
                           2: 84.51,
                           3: 84.32,
                           4: 84.94,
...
expected_speedup_compared_to_seq_no_recomp_no_comm: 4.473
Analysis max cuda memory used 4.36GB
"""