"""AutoGenerated with:
python -m autopipe.partition t5 --model_name_or_path t5-3b --t5_task squad1 --lmhead --n_iter 10 --analysis_batch_size 4 --partitioning_batch_size 4 --precompute_masks --stateless_tied --lmhead --n_partitions 16 --L 16 32 48 --max_seq_length 512 --answer_max_seq_length 4 --partitioning_method mpipe --preset ftpipe --dont_use_async_meta_alg --save_memory_mode --special_blocks T5Attention --bw 12
"""
...
# partition adjacency
# model inputs {0, 9, 15}
# partition 0 {'inputs': {'attention_mask', 'decoder_input_ids', 'input_ids'}, 'outputs': {1, 2, 3, 4, 5, 6, 7, 8, 9}}
...
# partition 9 {'inputs': {8, 0, 'decoder_attention_mask', 'inverted_encoder_attention_mask'}, 'outputs': {10, 11, 12, 13, 14, 15}}
...
# partition 15 {'inputs': {'lm_labels', 9, 14}, 'outputs': {'output'}}
# model outputs {15}
...
def create_pipeline_configuration(DEBUG=False, batch_size=4):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (T5LayerNorm,CrossEntropyLoss,Embedding,Dropout,StatelessEmbedding,Linear),
        'model_inputs': {
            'attention_mask': {
            ...
            4: {
                ...
                'outputs': {
                    'T5ForConditionalGeneration/T5Stack[encoder]/T5Block[0]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Tensor::__add___94_5': {
                        ...
                        'is_batched': True,
                        'used_by': [5]},
                    'T5ForConditionalGeneration/T5Stack[encoder]/T5Block[13]/T5LayerFF[1]/Tensor::__add___888': {
                        'shape': torch.Size([4, 512, 1024]),
                        'dtype': torch.float32,
                        'req_grad': True,
                        'is_batched': True,
            ...
            9: {
                ...
                'outputs': {
                    ...
                    'T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Tensor::__add___1658_10': {
                        ...
                        'is_batched': True,
                        'used_by': [10]},
                    'T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerFF[2]/Tensor::__add___1905': {
                        'shape': torch.Size([4, 4, 1024]),
                        'dtype': torch.float32,
                        'req_grad': True,
                        'is_batched': True,
            ...
            10: {
                ...
                'outputs': {
                    ...
                    'T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Tensor::__add___1658_11': {
                        ...
                        'is_batched': True,
                        'used_by': [11]},
                    'T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5]/T5LayerSelfAttention[0]/Tensor::__add___2176': {
                        'shape': torch.Size([4, 4, 1024]),
                        'dtype': torch.float32,
                        'req_grad': True,
                        'is_batched': True,
            ...
            13: {
                ...
                'outputs': {
                    ...
                    'T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Tensor::__add___1658_14': {
                        ...
                        'is_batched': True,
                        'used_by': [14]},
                    'T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerFF[2]/Tensor::__add___3005': {
                        'shape': torch.Size([4, 4, 1024]),
                        'dtype': torch.float32,
                        'req_grad': True,
                        'is_batched': True,
...
class Partition0(nn.Module):
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/StatelessEmbedding[embed_tokens] <=> self.l_51
...
class Partition2(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:2'):
        ...
        self.lookup = {'l_0': 'encoder.4.1.DenseReluDense.wi',
                        ...
                        'l_12': 'encoder.5.1.DenseReluDense.wi',
                        'l_13': 'encoder.5.1.DenseReluDense.dropout',
                        'l_14': 'encoder.5.1.DenseReluDense.wo',
                        'l_15': 'encoder.5.1.dropout',
                        'l_16': 'encoder.6.0.layer_norm',
                        'l_17': 'encoder.6.0.SelfAttention.q',
                        'l_18': 'encoder.6.0.SelfAttention.k',
                        'l_19': 'encoder.6.0.SelfAttention.v',
                        'l_20': 'encoder.6.0.SelfAttention.dropout',
                        'l_21': 'encoder.6.0.SelfAttention.o',
                        'l_22': 'encoder.6.0.dropout',
                        'l_23': 'encoder.6.1.layer_norm',
                        'l_24': 'encoder.6.1.DenseReluDense.wi',
                        'l_25': 'encoder.6.1.DenseReluDense.dropout',
                        'l_26': 'encoder.6.1.DenseReluDense.wo',
                        'l_27': 'encoder.6.1.dropout',
                        'l_28': 'encoder.7.0.layer_norm',
                        'l_29': 'encoder.7.0.SelfAttention.q',
                        'l_30': 'encoder.7.0.SelfAttention.k',
                        'l_31': 'encoder.7.0.SelfAttention.v',
                        'l_32': 'encoder.7.0.SelfAttention.dropout',
                        'l_33': 'encoder.7.0.SelfAttention.o',
                        'l_34': 'encoder.7.0.dropout',
                        'l_35': 'encoder.7.1.layer_norm',
                        'l_36': 'encoder.7.1.DenseReluDense.wi',
                        'l_37': 'encoder.7.1.DenseReluDense.dropout',
                        'l_38': 'encoder.7.1.DenseReluDense.wo',
                        'l_39': 'encoder.7.1.dropout',
                        'l_40': 'encoder.8.0.layer_norm',
                        'l_41': 'encoder.8.0.SelfAttention.q',
                        'l_42': 'encoder.8.0.SelfAttention.k',
                        'l_43': 'encoder.8.0.SelfAttention.v',
                        'l_44': 'encoder.8.0.SelfAttention.dropout',
                        'l_45': 'encoder.8.0.SelfAttention.o',
                        'l_46': 'encoder.8.0.dropout',
                        'l_47': 'encoder.8.1.layer_norm',
                        'l_48': 'encoder.8.1.DenseReluDense.wi',
                        'l_49': 'encoder.8.1.DenseReluDense.dropout',
                        'l_50': 'encoder.8.1.DenseReluDense.wo',
                        'l_51': 'encoder.8.1.dropout'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[5]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_12
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[5]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_13
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[5]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_14
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[5]/T5LayerFF[1]/Dropout[dropout] <=> self.l_15
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[6]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_16
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[6]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_17
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[6]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_18
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[6]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_19
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[6]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_20
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[6]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_21
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[6]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_22
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[6]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_23
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[6]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_24
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[6]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_25
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[6]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_26
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[6]/T5LayerFF[1]/Dropout[dropout] <=> self.l_27
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[7]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_28
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[7]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_29
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[7]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_30
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[7]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_31
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[7]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_32
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[7]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_33
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[7]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_34
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[7]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_35
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[7]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_36
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[7]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_37
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[7]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_38
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[7]/T5LayerFF[1]/Dropout[dropout] <=> self.l_39
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[8]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_40
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[8]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_41
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[8]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_42
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[8]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_43
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[8]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_44
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[8]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_45
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[8]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_46
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[8]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_47
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[8]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_48
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[8]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_49
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[8]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_50
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[8]/T5LayerFF[1]/Dropout[dropout] <=> self.l_51
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[0]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Tensor::__add___94 <=> x0
...
class Partition4(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:4'):
        ...
        self.lookup = {'l_0': 'encoder.9.1.DenseReluDense.wi',
                        ...
                        'l_36': 'encoder.12.1.DenseReluDense.wi',
                        'l_37': 'encoder.12.1.DenseReluDense.dropout',
                        'l_38': 'encoder.12.1.DenseReluDense.wo',
                        'l_39': 'encoder.12.1.dropout',
                        'l_40': 'encoder.13.0.layer_norm',
                        'l_41': 'encoder.13.0.SelfAttention.q',
                        'l_42': 'encoder.13.0.SelfAttention.k',
                        'l_43': 'encoder.13.0.SelfAttention.v',
                        'l_44': 'encoder.13.0.SelfAttention.dropout',
                        'l_45': 'encoder.13.0.SelfAttention.o',
                        'l_46': 'encoder.13.0.dropout',
                        'l_47': 'encoder.13.1.layer_norm',
                        'l_48': 'encoder.13.1.DenseReluDense.wi',
                        'l_49': 'encoder.13.1.DenseReluDense.dropout',
                        'l_50': 'encoder.13.1.DenseReluDense.wo',
                        'l_51': 'encoder.13.1.dropout'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[12]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_36
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[12]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_37
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[12]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_38
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[12]/T5LayerFF[1]/Dropout[dropout] <=> self.l_39
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[13]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_40
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[13]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_41
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[13]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_42
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[13]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_43
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[13]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_44
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[13]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_45
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[13]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_46
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[13]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_47
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[13]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_48
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[13]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_49
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[13]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_50
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[13]/T5LayerFF[1]/Dropout[dropout] <=> self.l_51
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[0]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Tensor::__add___94 <=> x0
...
class Partition5(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:5'):
        ...
        self.device = torch.device(device)
        self.input_structure = [1, 1]
        self.lookup = {'l_0': 'encoder.14.0.layer_norm',
                        'l_1': 'encoder.14.0.SelfAttention.q',
                        'l_2': 'encoder.14.0.SelfAttention.k',
                        'l_3': 'encoder.14.0.SelfAttention.v',
                        'l_4': 'encoder.14.0.SelfAttention.dropout',
                        'l_5': 'encoder.14.0.SelfAttention.o',
                        'l_6': 'encoder.14.0.dropout',
                        'l_7': 'encoder.14.1.layer_norm'}
        self.to(self.device)

    def forward(self, *args):
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[14]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_0
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[14]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_1
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[14]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_2
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[14]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_3
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[14]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_4
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[14]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_5
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[14]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_6
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[14]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_7
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[0]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Tensor::__add___94 <=> x0
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[13]/T5LayerFF[1]/Tensor::__add___888 <=> x1
        x0, x1 = unflatten(args, self.input_structure)
        t_0 = self.l_0(x1)
        t_1 = t_0.size()
        t_2 = self.l_1(t_0)
...
class Partition6(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:6'):
        ...
        self.lookup = {'l_0': 'encoder.14.1.DenseReluDense.wi',
                        ...
                        'l_12': 'encoder.15.1.DenseReluDense.wi',
                        'l_13': 'encoder.15.1.DenseReluDense.dropout',
                        'l_14': 'encoder.15.1.DenseReluDense.wo',
                        'l_15': 'encoder.15.1.dropout',
                        'l_16': 'encoder.16.0.layer_norm',
                        'l_17': 'encoder.16.0.SelfAttention.q',
                        'l_18': 'encoder.16.0.SelfAttention.k',
                        'l_19': 'encoder.16.0.SelfAttention.v',
                        'l_20': 'encoder.16.0.SelfAttention.dropout',
                        'l_21': 'encoder.16.0.SelfAttention.o',
                        'l_22': 'encoder.16.0.dropout',
                        'l_23': 'encoder.16.1.layer_norm',
                        'l_24': 'encoder.16.1.DenseReluDense.wi',
                        'l_25': 'encoder.16.1.DenseReluDense.dropout',
                        'l_26': 'encoder.16.1.DenseReluDense.wo',
                        'l_27': 'encoder.16.1.dropout',
                        'l_28': 'encoder.17.0.layer_norm',
                        'l_29': 'encoder.17.0.SelfAttention.q',
                        'l_30': 'encoder.17.0.SelfAttention.k',
                        'l_31': 'encoder.17.0.SelfAttention.v',
                        'l_32': 'encoder.17.0.SelfAttention.dropout',
                        'l_33': 'encoder.17.0.SelfAttention.o',
                        'l_34': 'encoder.17.0.dropout',
                        'l_35': 'encoder.17.1.layer_norm',
                        'l_36': 'encoder.17.1.DenseReluDense.wi',
                        'l_37': 'encoder.17.1.DenseReluDense.dropout',
                        'l_38': 'encoder.17.1.DenseReluDense.wo',
                        'l_39': 'encoder.17.1.dropout',
                        'l_40': 'encoder.18.0.layer_norm',
                        'l_41': 'encoder.18.0.SelfAttention.q',
                        'l_42': 'encoder.18.0.SelfAttention.k',
                        'l_43': 'encoder.18.0.SelfAttention.v',
                        'l_44': 'encoder.18.0.SelfAttention.dropout',
                        'l_45': 'encoder.18.0.SelfAttention.o',
                        'l_46': 'encoder.18.0.dropout',
                        'l_47': 'encoder.18.1.layer_norm',
                        'l_48': 'encoder.18.1.DenseReluDense.wi',
                        'l_49': 'encoder.18.1.DenseReluDense.dropout',
                        'l_50': 'encoder.18.1.DenseReluDense.wo',
                        'l_51': 'encoder.18.1.dropout'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[15]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_12
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[15]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_13
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[15]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_14
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[15]/T5LayerFF[1]/Dropout[dropout] <=> self.l_15
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[16]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_16
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[16]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_17
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[16]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_18
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[16]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_19
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[16]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_20
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[16]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_21
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[16]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_22
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[16]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_23
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[16]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_24
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[16]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_25
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[16]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_26
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[16]/T5LayerFF[1]/Dropout[dropout] <=> self.l_27
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[17]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_28
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[17]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_29
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[17]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_30
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[17]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_31
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[17]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_32
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[17]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_33
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[17]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_34
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[17]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_35
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[17]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_36
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[17]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_37
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[17]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_38
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[17]/T5LayerFF[1]/Dropout[dropout] <=> self.l_39
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[18]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_40
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[18]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_41
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[18]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_42
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[18]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_43
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[18]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_44
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[18]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_45
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[18]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_46
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[18]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_47
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[18]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_48
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[18]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_49
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[18]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_50
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[18]/T5LayerFF[1]/Dropout[dropout] <=> self.l_51
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[0]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Tensor::__add___94 <=> x0
...
class Partition7(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:7'):
        ...
        self.device = torch.device(device)
        self.input_structure = [1, 1]
        self.lookup = {'l_0': 'encoder.19.0.layer_norm',
                        'l_1': 'encoder.19.0.SelfAttention.q',
                        'l_2': 'encoder.19.0.SelfAttention.k',
                        'l_3': 'encoder.19.0.SelfAttention.v',
                        'l_4': 'encoder.19.0.SelfAttention.dropout',
                        'l_5': 'encoder.19.0.SelfAttention.o',
                        'l_6': 'encoder.19.0.dropout',
                        'l_7': 'encoder.19.1.layer_norm'}
        self.to(self.device)

    def forward(self, *args):
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[19]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_0
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[19]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_1
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[19]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_2
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[19]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_3
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[19]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_4
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[19]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_5
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[19]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_6
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[19]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_7
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[0]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Tensor::__add___94 <=> x0
...
class Partition8(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:8'):
        ...
        self.lookup = {'l_0': 'encoder.19.1.DenseReluDense.wi',
                        ...
                        'l_12': 'encoder.20.1.DenseReluDense.wi',
                        'l_13': 'encoder.20.1.DenseReluDense.dropout',
                        'l_14': 'encoder.20.1.DenseReluDense.wo',
                        'l_15': 'encoder.20.1.dropout',
                        'l_16': 'encoder.21.0.layer_norm',
                        'l_17': 'encoder.21.0.SelfAttention.q',
                        'l_18': 'encoder.21.0.SelfAttention.k',
                        'l_19': 'encoder.21.0.SelfAttention.v',
                        'l_20': 'encoder.21.0.SelfAttention.dropout',
                        'l_21': 'encoder.21.0.SelfAttention.o',
                        'l_22': 'encoder.21.0.dropout',
                        'l_23': 'encoder.21.1.layer_norm',
                        'l_24': 'encoder.21.1.DenseReluDense.wi',
                        'l_25': 'encoder.21.1.DenseReluDense.dropout',
                        'l_26': 'encoder.21.1.DenseReluDense.wo',
                        'l_27': 'encoder.21.1.dropout',
                        'l_28': 'encoder.22.0.layer_norm',
                        'l_29': 'encoder.22.0.SelfAttention.q',
                        'l_30': 'encoder.22.0.SelfAttention.k',
                        'l_31': 'encoder.22.0.SelfAttention.v',
                        'l_32': 'encoder.22.0.SelfAttention.dropout',
                        'l_33': 'encoder.22.0.SelfAttention.o',
                        ...
                        'l_38': 'encoder.22.1.DenseReluDense.wo',
                        'l_39': 'encoder.22.1.dropout',
                        'l_40': 'encoder.23.0.layer_norm',
                        'l_41': 'encoder.23.0.SelfAttention.q',
                        'l_42': 'encoder.23.0.SelfAttention.k',
                        'l_43': 'encoder.23.0.SelfAttention.v',
                        'l_44': 'encoder.23.0.SelfAttention.dropout',
                        'l_45': 'encoder.23.0.SelfAttention.o',
                        'l_46': 'encoder.23.0.dropout',
                        'l_47': 'encoder.23.1.layer_norm',
                        'l_48': 'encoder.23.1.DenseReluDense.wi',
                        'l_49': 'encoder.23.1.DenseReluDense.dropout',
                        'l_50': 'encoder.23.1.DenseReluDense.wo',
                        'l_51': 'encoder.23.1.dropout',
                        'l_52': 'encoder.final_layer_norm'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[20]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_12
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[20]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_13
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[20]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_14
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[20]/T5LayerFF[1]/Dropout[dropout] <=> self.l_15
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[21]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_16
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[21]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_17
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[21]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_18
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[21]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_19
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[21]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_20
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[21]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_21
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[21]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_22
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[21]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_23
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[21]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_24
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[21]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_25
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[21]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_26
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[21]/T5LayerFF[1]/Dropout[dropout] <=> self.l_27
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[22]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_28
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[22]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_29
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[22]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_30
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[22]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_31
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[22]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_32
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[22]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_33
        ...
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[22]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_38
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[22]/T5LayerFF[1]/Dropout[dropout] <=> self.l_39
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[23]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_40
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[23]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_41
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[23]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_42
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[23]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_43
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[23]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_44
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[23]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_45
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[23]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_46
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[23]/T5LayerFF[1]/T5LayerNorm[layer_norm] <=> self.l_47
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[23]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_48
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[23]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_49
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[23]/T5LayerFF[1]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_50
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[23]/T5LayerFF[1]/Dropout[dropout] <=> self.l_51
        # T5ForConditionalGeneration/T5Stack[encoder]/T5LayerNorm[final_layer_norm] <=> self.l_52
        # T5ForConditionalGeneration/T5Stack[encoder]/T5Block[0]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Tensor::__add___94 <=> x0
...
class Partition9(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:9'):
        ...
        self.lookup = {'l_0': 'encoder.dropout',
                        'l_1': 'decoder.dropout',
                        'l_2': 'decoder.0.0.layer_norm',
                        'l_3': 'decoder.0.0.SelfAttention.q',
                        'l_4': 'decoder.0.0.SelfAttention.k',
                        'l_5': 'decoder.0.0.SelfAttention.v',
                        'l_6': 'decoder.0.0.SelfAttention.relative_attention_bias',
                        'l_7': 'decoder.0.0.SelfAttention.dropout',
                        'l_8': 'decoder.0.0.SelfAttention.o',
                        'l_9': 'decoder.0.0.dropout',
                        'l_10': 'decoder.0.1.layer_norm',
                        'l_11': 'decoder.0.1.EncDecAttention.q',
                        'l_12': 'decoder.0.1.EncDecAttention.k',
                        'l_13': 'decoder.0.1.EncDecAttention.v',
                        'l_14': 'decoder.0.1.EncDecAttention.relative_attention_bias',
                        'l_15': 'decoder.0.1.EncDecAttention.dropout',
                        'l_16': 'decoder.0.1.EncDecAttention.o',
                        'l_17': 'decoder.0.1.dropout',
                        'l_18': 'decoder.0.2.layer_norm',
                        'l_19': 'decoder.0.2.DenseReluDense.wi',
                        'l_20': 'decoder.0.2.DenseReluDense.dropout',
                        'l_21': 'decoder.0.2.DenseReluDense.wo',
                        'l_22': 'decoder.0.2.dropout',
                        'l_23': 'decoder.1.0.layer_norm',
                        'l_24': 'decoder.1.0.SelfAttention.q',
                        'l_25': 'decoder.1.0.SelfAttention.k',
                        'l_26': 'decoder.1.0.SelfAttention.v',
                        'l_27': 'decoder.1.0.SelfAttention.dropout',
                        'l_28': 'decoder.1.0.SelfAttention.o',
                        'l_29': 'decoder.1.0.dropout',
                        'l_30': 'decoder.1.1.layer_norm',
                        'l_31': 'decoder.1.1.EncDecAttention.q',
                        'l_32': 'decoder.1.1.EncDecAttention.k',
                        'l_33': 'decoder.1.1.EncDecAttention.v',
                        'l_34': 'decoder.1.1.EncDecAttention.dropout',
                        'l_35': 'decoder.1.1.EncDecAttention.o',
                        'l_36': 'decoder.1.1.dropout',
                        'l_37': 'decoder.1.2.layer_norm',
                        'l_38': 'decoder.1.2.DenseReluDense.wi',
                        'l_39': 'decoder.1.2.DenseReluDense.dropout',
                        'l_40': 'decoder.1.2.DenseReluDense.wo',
                        'l_41': 'decoder.1.2.dropout',
                        'l_42': 'decoder.2.0.layer_norm',
                        'l_43': 'decoder.2.0.SelfAttention.q',
                        'l_44': 'decoder.2.0.SelfAttention.k',
                        'l_45': 'decoder.2.0.SelfAttention.v',
                        'l_46': 'decoder.2.0.SelfAttention.dropout',
                        'l_47': 'decoder.2.0.SelfAttention.o',
                        'l_48': 'decoder.2.0.dropout',
                        'l_49': 'decoder.2.1.layer_norm',
                        'l_50': 'decoder.2.1.EncDecAttention.q',
                        'l_51': 'decoder.2.1.EncDecAttention.k',
                        'l_52': 'decoder.2.1.EncDecAttention.v',
                        'l_53': 'decoder.2.1.EncDecAttention.dropout',
                        'l_54': 'decoder.2.1.EncDecAttention.o',
                        'l_55': 'decoder.2.1.dropout',
                        'l_56': 'decoder.2.2.layer_norm',
                        'l_57': 'decoder.2.2.DenseReluDense.wi',
                        'l_58': 'decoder.2.2.DenseReluDense.dropout',
                        'l_59': 'decoder.2.2.DenseReluDense.wo',
                        'l_60': 'decoder.2.2.dropout'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_2
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_3
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_4
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_5
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Embedding[relative_attention_bias] <=> self.l_6
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_7
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_8
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_9
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_10
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_11
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_12
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_13
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Embedding[relative_attention_bias] <=> self.l_14
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_15
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_16
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_17
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_18
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_19
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_20
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_21
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerFF[2]/Dropout[dropout] <=> self.l_22
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_23
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_24
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_25
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_26
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_27
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_28
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_29
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_30
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_31
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_32
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_33
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_34
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_35
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_36
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_37
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_38
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_39
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_40
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[1]/T5LayerFF[2]/Dropout[dropout] <=> self.l_41
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_42
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_43
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_44
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_45
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_46
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_47
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_48
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_49
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_50
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_51
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_52
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_53
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_54
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_55
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_56
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_57
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_58
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_59
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerFF[2]/Dropout[dropout] <=> self.l_60
        ...
        t_9 = torch.max(t_10, t_9)
        t_10 = t_9.float()
        t_13 = torch.less(t_9, 16)
        t_10 = t_10 / 16
        t_10 = torch.log(t_10)
        t_14 = math.log(8.0)
        t_14 = t_10 / t_14
        ...
        t_14 = 16 + t_14
        t_10 = torch.full_like(t_14, 31, device=self.device)
        t_10 = torch.min(t_14, t_10)
        t_10 = torch.where(t_13, t_9, t_10)
        t_10 = 0 + t_10
        t_10 = t_10.to(self.device)
        t_10 = self.l_6(t_10)
        t_10 = t_10.permute([2, 0, 1])
        t_10 = t_10.unsqueeze(0)
        t_10 = t_10 + decoder_attention_mask
        t_11 += t_10
        t_9 = t_11.float()
        ...
        t_8 = t_9 - t_8
        t_8 = -t_8
        t_9 = torch.zeros_like(t_8, device=self.device)
        t_9 = torch.max(t_8, t_9)
        t_8 = t_9.float()
        t_7 = torch.less(t_9, 16)
        t_8 = t_8 / 16
        t_8 = torch.log(t_8)
        t_13 = math.log(8.0)
        t_13 = t_8 / t_13
        ...
        t_8 = torch.where(t_7, t_9, t_8)
        t_8 = 0 + t_8
        t_8 = t_8.to(self.device)
        t_8 = self.l_14(t_8)
        t_8 = t_8.permute([2, 0, 1])
        t_8 = t_8.unsqueeze(0)
        t_8 = t_8 + inverted_encoder_attention_mask
        t_1 += t_8
        t_9 = t_1.float()
        t_9 = torch.nn.functional.softmax(t_9, dim=-1, _stacklevel=3, dtype=None)
        t_1 = t_9.type_as(t_1)
        ...
        t_11 = t_11.view(t_2, -1, 32, 128)
        t_11 = t_11.transpose(1, 2)
        t_9 = t_9.transpose(3, 2)
        t_9 = torch.matmul(t_1, t_9)
        t_9 += t_10
        t_1 = t_9.float()
        ...
        t_3 = t_3.transpose(1, 2)
        t_4 = t_4.view(t_11, -1, 32, 128)
        t_4 = t_4.transpose(1, 2)
        t_3 = t_3.transpose(3, 2)
        t_3 = torch.matmul(t_12, t_3)
        t_3 += t_8
        t_12 = t_3.float()
        t_12 = torch.nn.functional.softmax(t_12, dim=-1, _stacklevel=3, dtype=None)
        t_3 = t_12.type_as(t_3)
        t_3 = self.l_34(t_3)
        t_4 = torch.matmul(t_3, t_4)
        t_4 = t_4.transpose(1, 2)
        t_4 = t_4.contiguous()
        t_11 = t_4.view(t_11, -1, 4096)
        t_11 = self.l_35(t_11)
        t_11 = self.l_36(t_11)
        t_11 = t_2 + t_11
        t_2 = self.l_37(t_11)
        ...
        t_3 = t_3.transpose(1, 2)
        t_12 = t_12.view(t_4, -1, 32, 128)
        t_12 = t_12.transpose(1, 2)
        t_11 = t_11.view(t_4, -1, 32, 128)
        t_11 = t_11.transpose(1, 2)
        t_12 = t_12.transpose(3, 2)
        t_12 = torch.matmul(t_3, t_12)
        t_12 += t_10
        t_3 = t_12.float()
        t_3 = torch.nn.functional.softmax(t_3, dim=-1, _stacklevel=3, dtype=None)
        t_12 = t_3.type_as(t_12)
        t_12 = self.l_46(t_12)
        t_11 = torch.matmul(t_12, t_11)
        t_11 = t_11.transpose(1, 2)
        t_11 = t_11.contiguous()
        t_4 = t_11.view(t_4, -1, 4096)
        t_4 = self.l_47(t_4)
        t_4 = self.l_48(t_4)
        t_4 = t_2 + t_4
        t_2 = self.l_49(t_4)
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerFF[2]/Tensor::__add___1905
        return list(flatten((t_0, t_10, t_8, t_4)))
...
class Partition10(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:10'):
        ...
        self.lookup = {'l_0': 'decoder.3.0.layer_norm',
                        ...
                        'l_10': 'decoder.3.1.EncDecAttention.v',
                        'l_11': 'decoder.3.1.EncDecAttention.dropout',
                        'l_12': 'decoder.3.1.EncDecAttention.o',
                        'l_13': 'decoder.3.1.dropout',
                        'l_14': 'decoder.3.2.layer_norm',
                        'l_15': 'decoder.3.2.DenseReluDense.wi',
                        'l_16': 'decoder.3.2.DenseReluDense.dropout',
                        'l_17': 'decoder.3.2.DenseReluDense.wo',
                        'l_18': 'decoder.3.2.dropout',
                        'l_19': 'decoder.4.0.layer_norm',
                        'l_20': 'decoder.4.0.SelfAttention.q',
                        'l_21': 'decoder.4.0.SelfAttention.k',
                        'l_22': 'decoder.4.0.SelfAttention.v',
                        'l_23': 'decoder.4.0.SelfAttention.dropout',
                        'l_24': 'decoder.4.0.SelfAttention.o',
                        'l_25': 'decoder.4.0.dropout',
                        'l_26': 'decoder.4.1.layer_norm',
                        'l_27': 'decoder.4.1.EncDecAttention.q',
                        'l_28': 'decoder.4.1.EncDecAttention.k',
                        'l_29': 'decoder.4.1.EncDecAttention.v',
                        'l_30': 'decoder.4.1.EncDecAttention.dropout',
                        'l_31': 'decoder.4.1.EncDecAttention.o',
                        'l_32': 'decoder.4.1.dropout',
                        'l_33': 'decoder.4.2.layer_norm',
                        'l_34': 'decoder.4.2.DenseReluDense.wi',
                        'l_35': 'decoder.4.2.DenseReluDense.dropout',
                        'l_36': 'decoder.4.2.DenseReluDense.wo',
                        'l_37': 'decoder.4.2.dropout',
                        'l_38': 'decoder.5.0.layer_norm',
                        'l_39': 'decoder.5.0.SelfAttention.q',
                        'l_40': 'decoder.5.0.SelfAttention.k',
                        'l_41': 'decoder.5.0.SelfAttention.v',
                        'l_42': 'decoder.5.0.SelfAttention.dropout',
                        'l_43': 'decoder.5.0.SelfAttention.o',
                        'l_44': 'decoder.5.0.dropout'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[3]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_10
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[3]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_11
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[3]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_12
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[3]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_13
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[3]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_14
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[3]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_15
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[3]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_16
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[3]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_17
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[3]/T5LayerFF[2]/Dropout[dropout] <=> self.l_18
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_19
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_20
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_21
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_22
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_23
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_24
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_25
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_26
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_27
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_28
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_29
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_30
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_31
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_32
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_33
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_34
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_35
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_36
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[4]/T5LayerFF[2]/Dropout[dropout] <=> self.l_37
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_38
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_39
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_40
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_41
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_42
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_43
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_44
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[2]/T5LayerFF[2]/Tensor::__add___1905 <=> x3
...
class Partition11(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:11'):
        ...
        self.lookup = {'l_0': 'decoder.5.1.layer_norm',
                        'l_1': 'decoder.5.1.EncDecAttention.q',
                        'l_2': 'decoder.5.1.EncDecAttention.k',
                        'l_3': 'decoder.5.1.EncDecAttention.v',
                        'l_4': 'decoder.5.1.EncDecAttention.dropout',
                        'l_5': 'decoder.5.1.EncDecAttention.o',
                        'l_6': 'decoder.5.1.dropout',
                        'l_7': 'decoder.5.2.layer_norm',
                        'l_8': 'decoder.5.2.DenseReluDense.wi',
                        'l_9': 'decoder.5.2.DenseReluDense.dropout',
                        'l_10': 'decoder.5.2.DenseReluDense.wo',
                        'l_11': 'decoder.5.2.dropout',
                        'l_12': 'decoder.6.0.layer_norm',
                        'l_13': 'decoder.6.0.SelfAttention.q',
                        'l_14': 'decoder.6.0.SelfAttention.k',
                        'l_15': 'decoder.6.0.SelfAttention.v',
                        'l_16': 'decoder.6.0.SelfAttention.dropout',
                        'l_17': 'decoder.6.0.SelfAttention.o',
                        'l_18': 'decoder.6.0.dropout',
                        'l_19': 'decoder.6.1.layer_norm',
                        'l_20': 'decoder.6.1.EncDecAttention.q',
                        'l_21': 'decoder.6.1.EncDecAttention.k',
                        'l_22': 'decoder.6.1.EncDecAttention.v',
                        'l_23': 'decoder.6.1.EncDecAttention.dropout',
                        'l_24': 'decoder.6.1.EncDecAttention.o',
                        'l_25': 'decoder.6.1.dropout',
                        'l_26': 'decoder.6.2.layer_norm',
                        'l_27': 'decoder.6.2.DenseReluDense.wi',
                        'l_28': 'decoder.6.2.DenseReluDense.dropout',
                        'l_29': 'decoder.6.2.DenseReluDense.wo',
                        'l_30': 'decoder.6.2.dropout',
                        'l_31': 'decoder.7.0.layer_norm',
                        'l_32': 'decoder.7.0.SelfAttention.q',
                        'l_33': 'decoder.7.0.SelfAttention.k',
                        'l_34': 'decoder.7.0.SelfAttention.v',
                        'l_35': 'decoder.7.0.SelfAttention.dropout',
                        'l_36': 'decoder.7.0.SelfAttention.o',
                        'l_37': 'decoder.7.0.dropout',
                        'l_38': 'decoder.7.1.layer_norm',
                        'l_39': 'decoder.7.1.EncDecAttention.q',
                        'l_40': 'decoder.7.1.EncDecAttention.k',
                        'l_41': 'decoder.7.1.EncDecAttention.v',
                        'l_42': 'decoder.7.1.EncDecAttention.dropout',
                        'l_43': 'decoder.7.1.EncDecAttention.o',
                        'l_44': 'decoder.7.1.dropout',
                        'l_45': 'decoder.7.2.layer_norm',
                        'l_46': 'decoder.7.2.DenseReluDense.wi',
                        'l_47': 'decoder.7.2.DenseReluDense.dropout',
                        'l_48': 'decoder.7.2.DenseReluDense.wo',
                        'l_49': 'decoder.7.2.dropout'}
        self.to(self.device)

    def forward(self, *args):
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_0
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_1
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_2
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_3
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_4
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_5
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_6
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_9
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_10
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5]/T5LayerFF[2]/Dropout[dropout] <=> self.l_11
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_12
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_13
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_14
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_15
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_16
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_17
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_18
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_19
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_20
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_21
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_22
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_23
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_24
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_25
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_26
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_27
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_28
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_29
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[6]/T5LayerFF[2]/Dropout[dropout] <=> self.l_30
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[7]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_31
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[7]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_32
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[7]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_33
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[7]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_34
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[7]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_35
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[7]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_36
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[7]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_37
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[7]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_38
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[7]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_39
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[7]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_40
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[7]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_41
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[7]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_42
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[7]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_43
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[7]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_44
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[7]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_45
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[7]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_46
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[7]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_47
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[7]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_48
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[7]/T5LayerFF[2]/Dropout[dropout] <=> self.l_49
        # T5ForConditionalGeneration/T5Stack[encoder]/Dropout[dropout] <=> x0
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Tensor::__add___1562 <=> x1
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Tensor::__add___1658 <=> x2
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[5]/T5LayerSelfAttention[0]/Tensor::__add___2176 <=> x3
        x0, x1, x2, x3 = unflatten(args, self.input_structure)
        t_0 = self.l_2(x0)
        t_1 = self.l_3(x0)
        t_2 = self.l_21(x0)
...
class Partition12(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:12'):
        ...
        self.lookup = {'l_0': 'decoder.8.0.layer_norm',
                        ...
                        'l_19': 'decoder.9.0.layer_norm',
                        'l_20': 'decoder.9.0.SelfAttention.q',
                        'l_21': 'decoder.9.0.SelfAttention.k',
                        'l_22': 'decoder.9.0.SelfAttention.v',
                        'l_23': 'decoder.9.0.SelfAttention.dropout',
                        'l_24': 'decoder.9.0.SelfAttention.o',
                        'l_25': 'decoder.9.0.dropout',
                        'l_26': 'decoder.9.1.layer_norm',
                        'l_27': 'decoder.9.1.EncDecAttention.q',
                        'l_28': 'decoder.9.1.EncDecAttention.k',
                        'l_29': 'decoder.9.1.EncDecAttention.v',
                        'l_30': 'decoder.9.1.EncDecAttention.dropout',
                        'l_31': 'decoder.9.1.EncDecAttention.o',
                        ...
                        'l_39': 'decoder.10.0.SelfAttention.q',
                        'l_40': 'decoder.10.0.SelfAttention.k',
                        'l_41': 'decoder.10.0.SelfAttention.v',
                        'l_42': 'decoder.10.0.SelfAttention.dropout',
                        'l_43': 'decoder.10.0.SelfAttention.o',
                        'l_44': 'decoder.10.0.dropout'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[9]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_19
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[9]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_20
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[9]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_21
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[9]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_22
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[9]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_23
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[9]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_24
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[9]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_25
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[9]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_26
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[9]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_27
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[9]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_28
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[9]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_29
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[9]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_30
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[9]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_31
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_39
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_40
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_41
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_42
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_43
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_44
        # T5ForConditionalGeneration/T5Stack[encoder]/Dropout[dropout] <=> x0
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Tensor::__add___1562 <=> x1
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Tensor::__add___1658 <=> x2
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[9]/T5LayerFF[2]/Tensor::__add___2675
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10]/T5LayerSelfAttention[0]/Dropout[dropout]
        return list(flatten((x0, x1, x2, t_1, t_3)))
...
class Partition13(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:13'):
        ...
        self.lookup = {'l_0': 'decoder.10.1.layer_norm',
                        'l_1': 'decoder.10.1.EncDecAttention.q',
                        'l_2': 'decoder.10.1.EncDecAttention.k',
                        'l_3': 'decoder.10.1.EncDecAttention.v',
                        'l_4': 'decoder.10.1.EncDecAttention.dropout',
                        'l_5': 'decoder.10.1.EncDecAttention.o',
                        'l_6': 'decoder.10.1.dropout',
                        'l_7': 'decoder.10.2.layer_norm',
                        'l_8': 'decoder.10.2.DenseReluDense.wi',
                        'l_9': 'decoder.10.2.DenseReluDense.dropout',
                        'l_10': 'decoder.10.2.DenseReluDense.wo',
                        'l_11': 'decoder.10.2.dropout',
                        'l_12': 'decoder.11.0.layer_norm',
                        'l_13': 'decoder.11.0.SelfAttention.q',
                        'l_14': 'decoder.11.0.SelfAttention.k',
                        'l_15': 'decoder.11.0.SelfAttention.v',
                        'l_16': 'decoder.11.0.SelfAttention.dropout',
                        'l_17': 'decoder.11.0.SelfAttention.o',
                        'l_18': 'decoder.11.0.dropout',
                        'l_19': 'decoder.11.1.layer_norm',
                        'l_20': 'decoder.11.1.EncDecAttention.q',
                        'l_21': 'decoder.11.1.EncDecAttention.k',
                        'l_22': 'decoder.11.1.EncDecAttention.v',
                        'l_23': 'decoder.11.1.EncDecAttention.dropout',
                        'l_24': 'decoder.11.1.EncDecAttention.o',
                        'l_25': 'decoder.11.1.dropout',
                        'l_26': 'decoder.11.2.layer_norm',
                        'l_27': 'decoder.11.2.DenseReluDense.wi',
                        'l_28': 'decoder.11.2.DenseReluDense.dropout',
                        'l_29': 'decoder.11.2.DenseReluDense.wo',
                        'l_30': 'decoder.11.2.dropout',
                        'l_31': 'decoder.12.0.layer_norm',
                        'l_32': 'decoder.12.0.SelfAttention.q',
                        'l_33': 'decoder.12.0.SelfAttention.k',
                        'l_34': 'decoder.12.0.SelfAttention.v',
                        'l_35': 'decoder.12.0.SelfAttention.dropout',
                        'l_36': 'decoder.12.0.SelfAttention.o',
                        'l_37': 'decoder.12.0.dropout',
                        'l_38': 'decoder.12.1.layer_norm',
                        'l_39': 'decoder.12.1.EncDecAttention.q',
                        'l_40': 'decoder.12.1.EncDecAttention.k',
                        'l_41': 'decoder.12.1.EncDecAttention.v',
                        'l_42': 'decoder.12.1.EncDecAttention.dropout',
                        'l_43': 'decoder.12.1.EncDecAttention.o',
                        'l_44': 'decoder.12.1.dropout',
                        'l_45': 'decoder.12.2.layer_norm',
                        'l_46': 'decoder.12.2.DenseReluDense.wi',
                        'l_47': 'decoder.12.2.DenseReluDense.dropout',
                        'l_48': 'decoder.12.2.DenseReluDense.wo',
                        'l_49': 'decoder.12.2.dropout'}
        self.to(self.device)

    def forward(self, *args):
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_0
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_1
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_2
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_3
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_4
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_5
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_6
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_7
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_8
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_9
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_10
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10]/T5LayerFF[2]/Dropout[dropout] <=> self.l_11
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_12
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_13
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_14
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_15
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_16
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_17
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_18
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_19
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_20
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_21
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_22
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_23
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_24
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_25
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_26
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_27
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_28
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_29
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[11]/T5LayerFF[2]/Dropout[dropout] <=> self.l_30
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_31
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_32
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_33
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_34
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_35
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_36
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_37
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_38
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_39
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_40
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_41
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_42
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_43
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_44
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_45
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_46
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_47
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_48
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerFF[2]/Dropout[dropout] <=> self.l_49
        # T5ForConditionalGeneration/T5Stack[encoder]/Dropout[dropout] <=> x0
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Tensor::__add___1562 <=> x1
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Tensor::__add___1658 <=> x2
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[9]/T5LayerFF[2]/Tensor::__add___2675 <=> x3
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[10]/T5LayerSelfAttention[0]/Dropout[dropout] <=> x4
...
class Partition14(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:14'):
        ...
        self.device = torch.device(device)
        self.input_structure = [1, 1, 1, 1]
        self.lookup = {'l_0': 'decoder.13.0.layer_norm',
                        'l_1': 'decoder.13.0.SelfAttention.q',
                        'l_2': 'decoder.13.0.SelfAttention.k',
                        'l_3': 'decoder.13.0.SelfAttention.v',
                        'l_4': 'decoder.13.0.SelfAttention.dropout',
                        'l_5': 'decoder.13.0.SelfAttention.o',
                        'l_6': 'decoder.13.0.dropout',
                        'l_7': 'decoder.13.1.layer_norm',
                        'l_8': 'decoder.13.1.EncDecAttention.q',
                        'l_9': 'decoder.13.1.EncDecAttention.k',
                        'l_10': 'decoder.13.1.EncDecAttention.v',
                        'l_11': 'decoder.13.1.EncDecAttention.dropout',
                        'l_12': 'decoder.13.1.EncDecAttention.o',
                        'l_13': 'decoder.13.1.dropout',
                        'l_14': 'decoder.13.2.layer_norm',
                        'l_15': 'decoder.13.2.DenseReluDense.wi',
                        'l_16': 'decoder.13.2.DenseReluDense.dropout',
                        'l_17': 'decoder.13.2.DenseReluDense.wo',
                        ...
                        'l_34': 'decoder.14.2.DenseReluDense.wi',
                        'l_35': 'decoder.14.2.DenseReluDense.dropout',
                        'l_36': 'decoder.14.2.DenseReluDense.wo',
                        'l_37': 'decoder.14.2.dropout',
                        'l_38': 'decoder.15.0.layer_norm',
                        'l_39': 'decoder.15.0.SelfAttention.q',
                        'l_40': 'decoder.15.0.SelfAttention.k',
                        'l_41': 'decoder.15.0.SelfAttention.v',
                        'l_42': 'decoder.15.0.SelfAttention.dropout',
                        'l_43': 'decoder.15.0.SelfAttention.o',
                        'l_44': 'decoder.15.0.dropout',
                        'l_45': 'decoder.15.1.layer_norm',
                        'l_46': 'decoder.15.1.EncDecAttention.q',
                        'l_47': 'decoder.15.1.EncDecAttention.k',
                        'l_48': 'decoder.15.1.EncDecAttention.v',
                        'l_49': 'decoder.15.1.EncDecAttention.dropout',
                        'l_50': 'decoder.15.1.EncDecAttention.o',
                        'l_51': 'decoder.15.1.dropout',
                        'l_52': 'decoder.15.2.layer_norm',
                        'l_53': 'decoder.15.2.DenseReluDense.wi',
                        'l_54': 'decoder.15.2.DenseReluDense.dropout',
                        'l_55': 'decoder.15.2.DenseReluDense.wo',
                        'l_56': 'decoder.15.2.dropout',
                        'l_57': 'decoder.16.0.layer_norm',
                        'l_58': 'decoder.16.0.SelfAttention.q',
                        'l_59': 'decoder.16.0.SelfAttention.k',
                        'l_60': 'decoder.16.0.SelfAttention.v',
                        'l_61': 'decoder.16.0.SelfAttention.dropout',
                        'l_62': 'decoder.16.0.SelfAttention.o',
                        'l_63': 'decoder.16.0.dropout',
                        'l_64': 'decoder.16.1.layer_norm',
                        'l_65': 'decoder.16.1.EncDecAttention.q',
                        'l_66': 'decoder.16.1.EncDecAttention.k',
                        'l_67': 'decoder.16.1.EncDecAttention.v',
                        'l_68': 'decoder.16.1.EncDecAttention.dropout',
                        'l_69': 'decoder.16.1.EncDecAttention.o',
                        'l_70': 'decoder.16.1.dropout',
                        'l_71': 'decoder.16.2.layer_norm',
                        'l_72': 'decoder.16.2.DenseReluDense.wi',
                        'l_73': 'decoder.16.2.DenseReluDense.dropout',
                        'l_74': 'decoder.16.2.DenseReluDense.wo',
                        'l_75': 'decoder.16.2.dropout',
                        'l_76': 'decoder.17.0.layer_norm',
                        'l_77': 'decoder.17.0.SelfAttention.q',
                        'l_78': 'decoder.17.0.SelfAttention.k',
                        'l_79': 'decoder.17.0.SelfAttention.v',
                        'l_80': 'decoder.17.0.SelfAttention.dropout',
                        'l_81': 'decoder.17.0.SelfAttention.o',
                        'l_82': 'decoder.17.0.dropout',
                        'l_83': 'decoder.17.1.layer_norm',
                        'l_84': 'decoder.17.1.EncDecAttention.q',
                        'l_85': 'decoder.17.1.EncDecAttention.k',
                        'l_86': 'decoder.17.1.EncDecAttention.v',
                        'l_87': 'decoder.17.1.EncDecAttention.dropout',
                        'l_88': 'decoder.17.1.EncDecAttention.o',
                        'l_89': 'decoder.17.1.dropout',
                        'l_90': 'decoder.17.2.layer_norm',
                        'l_91': 'decoder.17.2.DenseReluDense.wi',
                        'l_92': 'decoder.17.2.DenseReluDense.dropout',
                        'l_93': 'decoder.17.2.DenseReluDense.wo',
                        'l_94': 'decoder.17.2.dropout'}
        self.to(self.device)

    def forward(self, *args):
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[13]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_0
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[13]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_1
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[13]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_2
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[13]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_3
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[13]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_4
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[13]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_5
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[13]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_6
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[13]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_7
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[13]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_8
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[13]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_9
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[13]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_10
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[13]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_11
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[13]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_12
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[13]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_13
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[13]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_14
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[13]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_15
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[13]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_16
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[13]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_17
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[14]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_34
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[14]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_35
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[14]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_36
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[14]/T5LayerFF[2]/Dropout[dropout] <=> self.l_37
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_38
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_39
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_40
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_41
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_42
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_43
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_44
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_45
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_46
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_47
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_48
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_49
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_50
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_51
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_52
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_53
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_54
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_55
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[15]/T5LayerFF[2]/Dropout[dropout] <=> self.l_56
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_57
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_58
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_59
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_60
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_61
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_62
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_63
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_64
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_65
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_66
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_67
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_68
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_69
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_70
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_71
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_72
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_73
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_74
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[16]/T5LayerFF[2]/Dropout[dropout] <=> self.l_75
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_76
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_77
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_78
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_79
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_80
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_81
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_82
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_83
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_84
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_85
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_86
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_87
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_88
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_89
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_90
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_91
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_92
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_93
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17]/T5LayerFF[2]/Dropout[dropout] <=> self.l_94
        # T5ForConditionalGeneration/T5Stack[encoder]/Dropout[dropout] <=> x0
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Tensor::__add___1562 <=> x1
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Tensor::__add___1658 <=> x2
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[12]/T5LayerFF[2]/Tensor::__add___3005 <=> x3
        x0, x1, x2, x3 = unflatten(args, self.input_structure)
        t_0 = self.l_9(x0)
        t_1 = self.l_10(x0)
        t_2 = self.l_28(x0)
        ...
        t_12 = t_13.float()
        t_12 = torch.nn.functional.softmax(t_12, dim=-1, _stacklevel=3, dtype=None)
        t_13 = t_12.type_as(t_13)
        t_13 = self.l_4(t_13)
        t_10 = torch.matmul(t_13, t_10)
        t_10 = t_10.transpose(1, 2)
        ...
        t_11 = t_11.transpose(1, 2)
        t_2 = t_2.view(t_13, -1, 32, 128)
        t_2 = t_2.transpose(1, 2)
        t_3 = t_3.view(t_13, -1, 32, 128)
        t_3 = t_3.transpose(1, 2)
        t_2 = t_2.transpose(3, 2)
        ...
        t_2 = t_2.view(t_3, -1, 32, 128)
        t_2 = t_2.transpose(1, 2)
        t_11 = t_11.view(t_3, -1, 32, 128)
        t_11 = t_11.transpose(1, 2)
        t_13 = t_13.view(t_3, -1, 32, 128)
        t_13 = t_13.transpose(1, 2)
        t_11 = t_11.transpose(3, 2)
        t_11 = torch.matmul(t_2, t_11)
        t_11 += x1
        t_2 = t_11.float()
        t_2 = torch.nn.functional.softmax(t_2, dim=-1, _stacklevel=3, dtype=None)
        t_11 = t_2.type_as(t_11)
        t_11 = self.l_42(t_11)
        t_13 = torch.matmul(t_11, t_13)
        t_13 = t_13.transpose(1, 2)
        t_13 = t_13.contiguous()
        t_3 = t_13.view(t_3, -1, 4096)
        t_3 = self.l_43(t_3)
        t_3 = self.l_44(t_3)
        t_3 = t_1 + t_3
        t_1 = self.l_45(t_3)
        ...
        t_1 = t_1.view(t_13, -1, 32, 128)
        t_1 = t_1.transpose(1, 2)
        t_4 = t_4.view(t_13, -1, 32, 128)
        t_4 = t_4.transpose(1, 2)
        t_5 = t_5.view(t_13, -1, 32, 128)
        t_5 = t_5.transpose(1, 2)
        t_4 = t_4.transpose(3, 2)
        t_4 = torch.matmul(t_1, t_4)
        t_4 += x2
        ...
        t_1 = t_4.type_as(t_1)
        t_1 = self.l_61(t_1)
        t_13 = torch.matmul(t_1, t_13)
        t_13 = t_13.transpose(1, 2)
        t_13 = t_13.contiguous()
        t_5 = t_13.view(t_5, -1, 4096)
        t_5 = self.l_62(t_5)
        t_5 = self.l_63(t_5)
        t_5 = t_3 + t_5
        t_3 = self.l_64(t_5)
        ...
        t_3 = t_3.view(t_13, -1, 32, 128)
        t_3 = t_3.transpose(1, 2)
        t_6 = t_6.view(t_13, -1, 32, 128)
        t_6 = t_6.transpose(1, 2)
        t_7 = t_7.view(t_13, -1, 32, 128)
        t_7 = t_7.transpose(1, 2)
        t_6 = t_6.transpose(3, 2)
        ...
        t_3 = t_6.type_as(t_3)
        t_3 = self.l_80(t_3)
        t_13 = torch.matmul(t_3, t_13)
        t_13 = t_13.transpose(1, 2)
        t_13 = t_13.contiguous()
        t_7 = t_13.view(t_7, -1, 4096)
        t_7 = self.l_81(t_7)
        t_7 = self.l_82(t_7)
        t_7 = t_5 + t_7
        t_5 = self.l_83(t_7)
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Tensor::__add___1658
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[17]/T5LayerFF[2]/Tensor::__add___3555
        return list(flatten((x0, x1, x2, t_7)))
...
class Partition15(nn.Module):
    ...
    def __init__(self, layers, tensors, device='cuda:15'):
        ...
        self.lookup = {'l_0': 'decoder.18.0.layer_norm',
                        ...
                        'l_61': 'decoder.21.0.SelfAttention.dropout',
                        'l_62': 'decoder.21.0.SelfAttention.o',
                        'l_63': 'decoder.21.0.dropout',
                        'l_64': 'decoder.21.1.layer_norm',
                        'l_65': 'decoder.21.1.EncDecAttention.q',
                        'l_66': 'decoder.21.1.EncDecAttention.k',
                        'l_67': 'decoder.21.1.EncDecAttention.v',
                        'l_68': 'decoder.21.1.EncDecAttention.dropout',
                        'l_69': 'decoder.21.1.EncDecAttention.o',
                        'l_70': 'decoder.21.1.dropout',
                        'l_71': 'decoder.21.2.layer_norm',
                        'l_72': 'decoder.21.2.DenseReluDense.wi',
                        'l_73': 'decoder.21.2.DenseReluDense.dropout',
                        'l_74': 'decoder.21.2.DenseReluDense.wo',
                        'l_75': 'decoder.21.2.dropout',
                        'l_76': 'decoder.22.0.layer_norm',
                        'l_77': 'decoder.22.0.SelfAttention.q',
                        'l_78': 'decoder.22.0.SelfAttention.k',
                        'l_79': 'decoder.22.0.SelfAttention.v',
                        'l_80': 'decoder.22.0.SelfAttention.dropout',
                        'l_81': 'decoder.22.0.SelfAttention.o',
                        'l_82': 'decoder.22.0.dropout',
                        'l_83': 'decoder.22.1.layer_norm',
                        'l_84': 'decoder.22.1.EncDecAttention.q',
                        'l_85': 'decoder.22.1.EncDecAttention.k',
                        'l_86': 'decoder.22.1.EncDecAttention.v',
                        'l_87': 'decoder.22.1.EncDecAttention.dropout',
                        'l_88': 'decoder.22.1.EncDecAttention.o',
                        'l_89': 'decoder.22.1.dropout',
                        'l_90': 'decoder.22.2.layer_norm',
                        'l_91': 'decoder.22.2.DenseReluDense.wi',
                        'l_92': 'decoder.22.2.DenseReluDense.dropout',
                        'l_93': 'decoder.22.2.DenseReluDense.wo',
                        'l_94': 'decoder.22.2.dropout',
                        'l_95': 'decoder.23.0.layer_norm',
                        'l_96': 'decoder.23.0.SelfAttention.q',
                        'l_97': 'decoder.23.0.SelfAttention.k',
                        'l_98': 'decoder.23.0.SelfAttention.v',
                        'l_99': 'decoder.23.0.SelfAttention.dropout',
                        'l_100': 'decoder.23.0.SelfAttention.o',
                        'l_101': 'decoder.23.0.dropout',
                        'l_102': 'decoder.23.1.layer_norm',
                        'l_103': 'decoder.23.1.EncDecAttention.q',
                        'l_104': 'decoder.23.1.EncDecAttention.k',
                        'l_105': 'decoder.23.1.EncDecAttention.v',
                        'l_106': 'decoder.23.1.EncDecAttention.dropout',
                        'l_107': 'decoder.23.1.EncDecAttention.o',
                        'l_108': 'decoder.23.1.dropout',
                        'l_109': 'decoder.23.2.layer_norm',
                        'l_110': 'decoder.23.2.DenseReluDense.wi',
                        'l_111': 'decoder.23.2.DenseReluDense.dropout',
                        'l_112': 'decoder.23.2.DenseReluDense.wo',
                        'l_113': 'decoder.23.2.dropout',
                        'l_114': 'decoder.final_layer_norm',
                        'l_115': 'decoder.dropout',
                        'l_116': 'lm_head',
                        'l_117': 'lm_loss'}
        self.to(self.device)
    ...
    def forward(self, *args):
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[21]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_61
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[21]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_62
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[21]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_63
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[21]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_64
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[21]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_65
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[21]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_66
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[21]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_67
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[21]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_68
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[21]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_69
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[21]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_70
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[21]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_71
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[21]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_72
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[21]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_73
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[21]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_74
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[21]/T5LayerFF[2]/Dropout[dropout] <=> self.l_75
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[22]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_76
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[22]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_77
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[22]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_78
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[22]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_79
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[22]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_80
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[22]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_81
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[22]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_82
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[22]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_83
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[22]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_84
        ...
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[22]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_87
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[22]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_88
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[22]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_89
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[22]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_90
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[22]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_91
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[22]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_92
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[22]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_93
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[22]/T5LayerFF[2]/Dropout[dropout] <=> self.l_94
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerSelfAttention[0]/T5LayerNorm[layer_norm] <=> self.l_95
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[q] <=> self.l_96
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[k] <=> self.l_97
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[v] <=> self.l_98
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Dropout[dropout] <=> self.l_99
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Linear[o] <=> self.l_100
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerSelfAttention[0]/Dropout[dropout] <=> self.l_101
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerCrossAttention[1]/T5LayerNorm[layer_norm] <=> self.l_102
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[q] <=> self.l_103
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[k] <=> self.l_104
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[v] <=> self.l_105
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Dropout[dropout] <=> self.l_106
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Linear[o] <=> self.l_107
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerCrossAttention[1]/Dropout[dropout] <=> self.l_108
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerFF[2]/T5LayerNorm[layer_norm] <=> self.l_109
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wi] <=> self.l_110
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Dropout[dropout] <=> self.l_111
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerFF[2]/T5DenseReluDense[DenseReluDense]/Linear[wo] <=> self.l_112
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[23]/T5LayerFF[2]/Dropout[dropout] <=> self.l_113
        # T5ForConditionalGeneration/T5Stack[decoder]/T5LayerNorm[final_layer_norm] <=> self.l_114
        # T5ForConditionalGeneration/T5Stack[decoder]/Dropout[dropout] <=> self.l_115
        # T5ForConditionalGeneration/Linear[lm_head] <=> self.l_116
        # T5ForConditionalGeneration/CrossEntropyLoss[lm_loss] <=> self.l_117
        # input5 <=> lm_labels
        # T5ForConditionalGeneration/T5Stack[encoder]/Dropout[dropout] <=> x0
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerSelfAttention[0]/T5Attention[SelfAttention]/Tensor::__add___1562 <=> x1
        # T5ForConditionalGeneration/T5Stack[decoder]/T5Block[0]/T5LayerCrossAttention[1]/T5Attention[EncDecAttention]/Tensor::__add___1658 <=> x2
        ...
        t_12 = t_12.transpose(1, 2)
        t_0 = t_0.view(t_15, -1, 32, 128)
        t_0 = t_0.transpose(1, 2)
        t_1 = t_1.view(t_15, -1, 32, 128)
        t_1 = t_1.transpose(1, 2)
        t_0 = t_0.transpose(3, 2)
        t_0 = torch.matmul(t_12, t_0)
        t_0 += x2
        t_12 = t_0.float()
        t_12 = torch.nn.functional.softmax(t_12, dim=-1, _stacklevel=3, dtype=None)
        ...
        t_0 = t_0.view(t_1, -1, 32, 128)
        t_0 = t_0.transpose(1, 2)
        t_12 = t_12.view(t_1, -1, 32, 128)
        t_12 = t_12.transpose(1, 2)
        t_15 = t_15.view(t_1, -1, 32, 128)
        t_15 = t_15.transpose(1, 2)
        t_12 = t_12.transpose(3, 2)
        ...
        t_15 = t_15.transpose(1, 2)
        t_15 = t_15.contiguous()
        t_1 = t_15.view(t_1, -1, 4096)
        t_1 = self.l_24(t_1)
        t_1 = self.l_25(t_1)
        t_1 = t_13 + t_1
        t_13 = self.l_26(t_1)
        ...
        t_2 = t_13.type_as(t_2)
        t_2 = self.l_30(t_2)
        t_3 = torch.matmul(t_2, t_3)
        t_3 = t_3.transpose(1, 2)
        t_3 = t_3.contiguous()
        t_15 = t_3.view(t_15, -1, 4096)
        t_15 = self.l_31(t_15)
        t_15 = self.l_32(t_15)
        t_15 = t_1 + t_15
        t_1 = self.l_33(t_15)
        ...
        t_13 = t_13.view(t_3, -1, 32, 128)
        t_13 = t_13.transpose(1, 2)
        t_15 = t_15.view(t_3, -1, 32, 128)
        t_15 = t_15.transpose(1, 2)
        t_13 = t_13.transpose(3, 2)
        t_13 = torch.matmul(t_2, t_13)
        t_13 += x1
        t_2 = t_13.float()
        t_2 = torch.nn.functional.softmax(t_2, dim=-1, _stacklevel=3, dtype=None)
        t_13 = t_2.type_as(t_13)
        t_13 = self.l_42(t_13)
        t_15 = torch.matmul(t_13, t_15)
        t_15 = t_15.transpose(1, 2)
        t_15 = t_15.contiguous()
        t_3 = t_15.view(t_3, -1, 4096)
        t_3 = self.l_43(t_3)
        t_3 = self.l_44(t_3)
        t_3 = t_1 + t_3
        t_1 = self.l_45(t_3)
        ...
        t_1 = t_1.view(t_15, -1, 32, 128)
        t_1 = t_1.transpose(1, 2)
        t_4 = t_4.view(t_15, -1, 32, 128)
        t_4 = t_4.transpose(1, 2)
        t_5 = t_5.view(t_15, -1, 32, 128)
        t_5 = t_5.transpose(1, 2)
        t_4 = t_4.transpose(3, 2)
        t_4 = torch.matmul(t_1, t_4)
        t_4 += x2
        ...
        t_1 = t_4.type_as(t_1)
        t_1 = self.l_61(t_1)
        t_15 = torch.matmul(t_1, t_15)
        t_15 = t_15.transpose(1, 2)
        t_15 = t_15.contiguous()
        t_5 = t_15.view(t_5, -1, 4096)
        t_5 = self.l_62(t_5)
        t_5 = self.l_63(t_5)
        t_5 = t_3 + t_5
        t_3 = self.l_64(t_5)
        ...
        t_3 = t_3.view(t_15, -1, 32, 128)
        t_3 = t_3.transpose(1, 2)
        t_6 = t_6.view(t_15, -1, 32, 128)
        t_6 = t_6.transpose(1, 2)
        t_7 = t_7.view(t_15, -1, 32, 128)
        t_7 = t_7.transpose(1, 2)
        t_6 = t_6.transpose(3, 2)
        t_6 = torch.matmul(t_3, t_6)
        t_6 += x2
        ...
        t_3 = t_6.type_as(t_3)
        t_3 = self.l_80(t_3)
        t_15 = torch.matmul(t_3, t_15)
        t_15 = t_15.transpose(1, 2)
        t_15 = t_15.contiguous()
        t_7 = t_15.view(t_7, -1, 4096)
        t_7 = self.l_81(t_7)
        t_7 = self.l_82(t_7)
        t_7 = t_5 + t_7
        t_5 = self.l_83(t_7)
        ...
        t_5 = t_5.view(t_15, -1, 32, 128)
        t_5 = t_5.transpose(1, 2)
        t_8 = t_8.view(t_15, -1, 32, 128)
        t_8 = t_8.transpose(1, 2)
        t_9 = t_9.view(t_15, -1, 32, 128)
        t_9 = t_9.transpose(1, 2)
        t_8 = t_8.transpose(3, 2)
        t_8 = torch.matmul(t_5, t_8)
        t_8 += x2
        ...
        t_5 = t_8.type_as(t_5)
        t_5 = self.l_99(t_5)
        t_15 = torch.matmul(t_5, t_15)
        t_15 = t_15.transpose(1, 2)
        t_15 = t_15.contiguous()
        t_9 = t_15.view(t_9, -1, 4096)
        t_9 = self.l_100(t_9)
        t_9 = self.l_101(t_9)
        t_9 = t_7 + t_9
        t_7 = self.l_102(t_9)
        ...
        t_7 = t_7.view(t_15, -1, 32, 128)
        t_7 = t_7.transpose(1, 2)
        t_10 = t_10.view(t_15, -1, 32, 128)
        t_10 = t_10.transpose(1, 2)
        t_11 = t_11.view(t_15, -1, 32, 128)
        t_11 = t_11.transpose(1, 2)
        t_10 = t_10.transpose(3, 2)
        ...
        t_11 = t_11.transpose(1, 2)
        t_11 = t_11.contiguous()
        t_15 = t_11.view(t_15, -1, 4096)
        t_15 = self.l_107(t_15)
        t_15 = self.l_108(t_15)
        t_15 = t_9 + t_15
        t_9 = self.l_109(t_15)
        t_9 = self.l_110(t_9)
        ...
        t_9 = self.l_116(t_9)
        t_15 = t_9.size(-1)
        t_15 = t_9.view(-1, t_15)
        t_9 = lm_labels.view(-1)
        t_9 = self.l_117(t_15, t_9)
        # Returning:
        # T5ForConditionalGeneration/CrossEntropyLoss[lm_loss]
        return (t_9,)
...
forward {0: 53.22, 1: 20.74, 2: 53.94, 3: 20.46, 4: 54.54, 5: 20.15, 6: 54.42, 7: 20.43, 8: 43.7, 9: 6.78, 10: 5.33, 11: 5.93, 12: 5.02, 13: 5.78, 14: 10.39, 15: 11.01}
backward {0: 125.01, 1: 26.67, 2: 123.17, 3: 26.91, 4: 122.75, 5: 27.08, 6: 122.53, 7: 26.6, 8: 122.44, 9: 26.11, 10: 11.61, 11: 15.78, 12: 11.66, 13: 15.82, 14: 29.37, 15: 24.0}
...
forward {0: 0.76, 1: 0.15, 2: 0.77, 3: 0.15, 4: 0.78, 5: 0.14, 6: 0.78, 7: 0.14, 8: 0.79, 9: 0.11, 10: 0.09, 11: 0.1, 12: 0.08, 13: 0.09, 14: 0.18, 15: 0.2}
backward {0: 1.0, 1: 0.12, 2: 0.89, 3: 0.12, 4: 0.88, 5: 0.12, 6: 0.88, 7: 0.12, 8: 0.88, 9: 0.2, 10: 0.08, 11: 0.12, 12: 0.08, 13: 0.12, 14: 0.22, 15: 0.18}

worstcase: bwd: 125.014 fwd: 54.538
Expected speedup for 16 partitions is: 5.786
...
1: input size:'142.61 MB', recieve_time:'11.88 ms', out:'150.99 MB', send time:'12.58 ms'
2: input size:'150.99 MB', recieve_time:'12.58 ms', out:'142.61 MB', send time:'11.88 ms'
3: input size:'142.61 MB', recieve_time:'11.88 ms', out:'150.99 MB', send time:'12.58 ms'
4: input size:'150.99 MB', recieve_time:'12.58 ms', out:'142.61 MB', send time:'11.88 ms'
5: input size:'142.61 MB', recieve_time:'11.88 ms', out:'150.99 MB', send time:'12.58 ms'
6: input size:'150.99 MB', recieve_time:'12.58 ms', out:'142.61 MB', send time:'11.88 ms'
7: input size:'142.61 MB', recieve_time:'11.88 ms', out:'150.99 MB', send time:'12.58 ms'
8: input size:'150.99 MB', recieve_time:'12.58 ms', out:'8.39 MB', send time:'0.70 ms'
9: input size:'8.45 MB', recieve_time:'0.70 ms', out:'9.51 MB', send time:'0.79 ms'
10: input size:'9.51 MB', recieve_time:'0.79 ms', out:'9.51 MB', send time:'0.79 ms'
11: input size:'9.51 MB', recieve_time:'0.79 ms', out:'9.51 MB', send time:'0.79 ms'
12: input size:'9.51 MB', recieve_time:'0.79 ms', out:'9.58 MB', send time:'0.80 ms'
13: input size:'9.58 MB', recieve_time:'0.80 ms', out:'9.51 MB', send time:'0.79 ms'
14: input size:'9.51 MB', recieve_time:'0.79 ms', out:'9.51 MB', send time:'0.79 ms'
15: input size:'9.51 MB', recieve_time:'0.79 ms', out:'0.00 MB', send time:'0.00 ms'

Compuatation Communication ratio (comp/(comp+comm)):
forward {0: 0.78, 1: 0.39, 2: 0.78, 3: 0.39, 4: 0.78, 5: 0.38, 6: 0.78, 7: 0.38, 8: 0.98, 9: 0.88, 10: 0.85, 11: 0.87, 12: 0.84, 13: 0.86, 14: 0.92, 15: 1.0} 
backward {0: 1.0, 1: 0.55, 2: 0.9, 3: 0.56, 4: 0.9, 5: 0.56, 6: 0.9, 7: 0.55, 8: 0.9, 9: 0.97, 10: 0.93, 11: 0.95, 12: 0.93, 13: 0.95, 14: 0.97, 15: 0.97}
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_no_comm': {0: 166.35,
                      ...
                      'worstcase': 166.35,
                      'worstcase_std': 2.86},
 'pipeline_vs_seq_no_comm': 4.59,
 'pipeline_with_non_parallel_comm': {0: 178.23,
                                     1: 47.41,
                                     2: 177.11,
                                     3: 47.37,
                                     4: 177.29,
                                     ...
                                     15: 35.01,
                                     'worstcase': 178.23},
 'seq_no_comm_no_recomp': {0: 124.79,
                           1: 15.07,
                           2: 109.07,
                           3: 15.02,
                           4: 109.03,
...
expected_speedup_compared_to_seq_no_recomp_no_comm: 4.254
Analysis max cuda memory used 5.46GB
"""