"""AutoGenerated with:
python -m autopipe.partition t5 --model_name_or_path t5-3b --t5_task squad1 --lmhead --n_iter 10 --analysis_batch_size 4 --partitioning_batch_size 4 --precompute_masks --stateless_tied --lmhead --n_partitions 16 --L 16 32 48 --max_seq_length 512 --answer_max_seq_length 4 --partitioning_method mpipe --preset ftpipe --dont_use_async_meta_alg --save_memory_mode --special_blocks T5DenseReluDense --disable_op_profiling --output_file test_layer_graph_
"""
...
def create_pipeline_configuration(DEBUG=False, batch_size=4):
    config = {
        'batch_dim': 0,
        'depth': 10000,
        'basic_blocks': (CrossEntropyLoss,T5LayerNorm,Embedding,Linear,Dropout,StatelessEmbedding),
        'model_inputs': {
            'attention_mask': {
...
def test_layer_graph_t5_3b_tied_lmheads_512_4_16p_bw12_async_squad1_mpipe():
...
forward {0: 56.1, 1: 43.81, 2: 47.2, 3: 46.42, 4: 48.03, 5: 44.69, 6: 45.78, 7: 28.7, 8: 7.23, 9: 7.3, 10: 7.39, 11: 7.44, 12: 7.44, 13: 7.12, 14: 7.23, 15: 4.53}
backward {0: 133.16, 1: 98.55, 2: 101.02, 3: 99.49, 4: 95.28, 5: 97.25, 6: 94.51, 7: 88.38, 8: 19.72, 9: 19.84, 10: 20.07, 11: 19.58, 12: 19.8, 13: 19.76, 14: 19.76, 15: 9.55}
...
forward {0: 0.78, 1: 0.56, 2: 0.62, 3: 0.61, 4: 0.63, 5: 0.57, 6: 0.59, 7: 0.5, 8: 0.12, 9: 0.12, 10: 0.12, 11: 0.12, 12: 0.12, 13: 0.12, 14: 0.12, 15: 0.08}
backward {0: 1.0, 1: 0.65, 2: 0.67, 3: 0.66, 4: 0.62, 5: 0.64, 6: 0.62, 7: 0.57, 8: 0.14, 9: 0.14, 10: 0.14, 11: 0.14, 12: 0.14, 13: 0.14, 14: 0.14, 15: 0.06}

worstcase: bwd: 133.161 fwd: 56.102
Expected speedup for 16 partitions is: 6.233
...
forward {0: 0.78, 1: 0.71, 2: 0.73, 3: 0.73, 4: 0.74, 5: 0.72, 6: 0.73, 7: 0.97, 8: 0.89, 9: 0.89, 10: 0.89, 11: 0.89, 12: 0.89, 13: 0.89, 14: 0.89, 15: 1.0} 
backward {0: 1.0, 1: 0.87, 2: 0.88, 3: 0.87, 4: 0.87, 5: 0.87, 6: 0.87, 7: 0.86, 8: 0.96, 9: 0.96, 10: 0.96, 11: 0.96, 12: 0.96, 13: 0.96, 14: 0.96, 15: 0.92}
...
Analysis for T = fwd + bwd:
 ...
 'pipeline_no_comm': {0: 176.67,
                      ...
                      'worstcase': 176.67,
                      'worstcase_std': 3.98},
 'pipeline_vs_seq_no_comm': 4.14,
 'pipeline_with_non_parallel_comm': {0: 189.26,
                                     1: 142.37,
                                     2: 148.23,
                                     3: 145.91,
                                     4: 143.3,
                                     ...
                                     15: 14.07,
                                     'worstcase': 189.26},
 'seq_no_comm_no_recomp': {0: 104.12,
                           1: 69.33,
                           2: 72.13,
                           3: 72.7,
                           4: 72.43,
...
expected_speedup_compared_to_seq_no_recomp_no_comm: 3.861
